...
secret_key = 'nguyenhung-secretkey'
...
canonical_querystring += '&X-Amz-Algorithm=AWS4-HMAC-SHA1'
...
# empty string ("").
payload_hash = hashlib.sha1(('').encode('utf-8')).hexdigest()
