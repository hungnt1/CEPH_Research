...
- Thực hiện khởi tạo key cho việc bootstrap OSD
```
sudo ceph-authtool --create-keyring /var/lib/ceph/bootstrap-osd/ceph.keyring --gen-key -n client.bootstrap-osd.2 --cap mon 'profile bootstrap-osd'
